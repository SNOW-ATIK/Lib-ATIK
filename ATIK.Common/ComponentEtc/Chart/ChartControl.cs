...
namespace ATIK
{
    public partial class ChartControl : UserControl
    {
        ...
        public bool AddData_Array(string SeriesName, List<double> XDataArray, List<double> YDataArray)       //그래프 1개 추가
        {
            bool IsSuccess = false;
        ...
        public void SetLineWidth(string seriesName, int width)
        {
            this.Invoke(new MethodInvoker(delegate ()
            {
                Series series = chart.Series.FindByName(seriesName);
