...
namespace CrevisFnIoLib
{
    class CrevisFnIO
    {
        ...
        public int FNIO_IoGetParam(IntPtr hSlot, int Cmd, ref int pData, int DataSize)
        {
            int Info = DATA_VALUE; 
            return IoGetParam(hSlot, Cmd, Info, ref pData, ref DataSize);
        }

        public int FNIO_IoSetParam(IntPtr hSlot, int Cmd, int Data, int DataSize)
        {
            return IoSetParam(hSlot, Cmd, ref Data, ref DataSize);
        }
